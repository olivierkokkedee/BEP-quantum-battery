...
#
#Python has trouble when I fill in the entire time-array as input in the functions
#E_t_num and fluc_t_num, as e.g. Hb and rho_b are multi-dimensional arrays
#as well. This is why I loop over the time function.
#
jjj=0
for t_step in t:
